  ...
  return (
     ...
     <div className='container'>
       <div className='row'>
         ...
         <div className='col-xs-6 col-md-3 d-flex align-items-center justify-content-end'>
            <div>
              <h6>Categories</h6>
     ...
     <div className='container'>
       <div className='row'>
        ...
        <a href='#'>Binary Chemist</a>.
         ...
         <div className='col-md-4 col-sm-6 col-xs-12 d-flex align-items-center justify-content-end'>
